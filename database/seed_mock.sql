...
INSERT INTO projects (
  id, name, code, description, prd,
  objective, problem, expected_outcome, extra_details, main_requirements, business_rules,
  status, start_date, end_date, owner_id, approved_by, created_by, budget, currency
) VALUES
(
  1, 'ระบบแจ้งปัญหาภายใน', 'ISSUE-01',
  'วัตถุประสงค์:\nแพลตฟอร์มรวมศูนย์สำหรับแจ้งปัญหาและติดตามสถานะ\n\nปัญหาเดิม:\nการแจ้งปัญหากระจายหลายช่องทาง ติดตามยาก\n\nผลลัพธ์ที่คาดหวัง:\nติดตามสถานะได้แบบ real-time',
  'ฟีเจอร์/ความต้องการหลัก:\nผู้ใช้ทั่วไปแจ้งปัญหาได้ง่าย ทีม IT รับงานและอัปเดตสถานะได้แบบ real-time',
  'แพลตฟอร์มรวมศูนย์สำหรับแจ้งปัญหาและติดตามสถานะ',
  'การแจ้งปัญหากระจายหลายช่องทาง ติดตามยาก',
  'ติดตามสถานะได้แบบ real-time',
  NULL,
  'ผู้ใช้ทั่วไปแจ้งปัญหาได้ง่าย ทีม IT รับงานและอัปเดตสถานะได้แบบ real-time',
  NULL,
  'active', '2026-06-01', '2026-09-30', 1, 1, 1, 250000.00, 'THB'
),
(
  2, 'เว็บไซต์องค์กร', 'WEB-02',
  'วัตถุประสงค์:\nรีดีไซน์เว็บไซต์องค์กรและหน้า Landing\n\nปัญหาเดิม:\nเว็บเดิมไม่รองรับมือถือและอัปเดตเนื้อหายาก\n\nผลลัพธ์ที่คาดหวัง:\nเว็บโหลดเร็ว ใช้งานบนมือถือได้ดี',
  'ฟีเจอร์/ความต้องการหลัก:\nรองรับมือถือ โหลดเร็ว และมีระบบจัดการเนื้อหาเบื้องต้น',
  'รีดีไซน์เว็บไซต์องค์กรและหน้า Landing',
  'เว็บเดิมไม่รองรับมือถือและอัปเดตเนื้อหายาก',
  'เว็บโหลดเร็ว ใช้งานบนมือถือได้ดี',
  NULL,
  'รองรับมือถือ โหลดเร็ว และมีระบบจัดการเนื้อหาเบื้องต้น',
  NULL,
  'active', '2026-05-15', '2026-08-31', 1, 1, 1, 180000.00, 'THB'
),
(
  3, 'แอปจองห้องประชุม', 'MEET-03',
  'วัตถุประสงค์:\nระบบจองห้องประชุมและอุปกรณ์\n\nปัญหาเดิม:\nจองห้องผ่านแชทและตารางแชร์ ทำให้ชนกันบ่อย\n\nผลลัพธ์ที่คาดหวัง:\nจองห้องได้ชัดเจนและลดการชนกันของตาราง',
  'ฟีเจอร์/ความต้องการหลัก:\nปฏิทินจองห้อง แจ้งเตือน และอนุมัติโดยแอดมิน',
  'ระบบจองห้องประชุมและอุปกรณ์',
  'จองห้องผ่านแชทและตารางแชร์ ทำให้ชนกันบ่อย',
  'จองห้องได้ชัดเจนและลดการชนกันของตาราง',
  NULL,
  'ปฏิทินจองห้อง แจ้งเตือน และอนุมัติโดยแอดมิน',
  NULL,
  'active', '2026-07-01', '2026-10-15', 2, 2, 2, 95000.00, 'THB'
);
